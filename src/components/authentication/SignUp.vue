...
const ifGoogleAuthError = computed(() => {return userAuthStore.googleAuthError })
  ...
  >
    <div class="max-w-[500px] mx-auto my-0">
      ...
      <button
        ...
        class="py-4 rounded-full border border-2 border-green-500 bg-[#3CB371] px-10"
      >
   ...
   <!--- if User hasn't Signup -->
    ...
    <div class="bg-[url('./assets/backgroundmovie.jpg')] font-[poppins] h-screen">
      <div class="bg-[rgb(0,0,0,0.8)] h-screen p-5 text-white content-center">
        <div class="max-w-[500px] grid mx-auto my-0 border border-2 rounded-md p-4">
          ...
          <p class="text-[14px] text-center">
            ...
            <router-link to="/login" class="underline text-blue-500">Login</router-link>
          </p>
